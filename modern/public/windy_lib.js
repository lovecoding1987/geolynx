...
!function() {
    ...
    window.onerror = e.bind(null, "error");
    try {
        new Float32Array(100)
    } catch (t) {
        return e("startup", "Type Array not supported", null, null, null, t, "errorLogger"),
...
Copyright(c) 2011 Daniel Lamb <daniellmb.com> MIT Licensed */
    ...
    if (t)
        var n = 0
          , i = ["red", "darkcyan", "green", "orange", "darkblue", "violet", "darkgreen", "blue", "brown", "blueviolet", "coral", "darkcyan", "midnightblue"];
    var s = [];
    return W.latestBcasts = s,
    e.extend({
        _init: function() {
            this.latestId = 1,
            this._eventedCache = {},
            t && (this.terminalColor = i[n],
            ++n > i.length - 1 && (n = 0)),
        ...
        emit: function(e, n, i, a, r) {
            var o, l, c;
            t && console.log("%c" + this.ident + ": " + e, "color:" + this.terminalColor, n || "", i || "", a || "", r || ""),
            o = this.ident,
            l = e,
            c = n,
            s.push({
            ...
            if (d)
                for (var u = d.length; u--; ) {
                    var h = d[u];
                    try {
                        h.callback.call(h.context, n, i, a, r),
...
W.define("http", ["lruCache", "rootScope", "utils", "broadcast"], function(e, t, n, i) {
    ...
    var c = function(e) {
      ...
      , u = function(e, o, l) {
        ...
        /^\/?forecast\//.test(p))) {
            var w = /^(.+)\/forecast\/([^/]+)\/([^/]+)\/(.+)$/.exec(o)
              , y = w[1]
              , b = w[2]
              , T = w[3]
              , L = b + "/" + T + "/" + w[4];
            o = y + "/" + ("Zm9yZWNhc3Q/" + window.btoa(T).replace(/=/g, "")) + "/" + window.btoa(L).replace(/=/g, ""),
            v = !0
        }
        o = encodeURI(o),
        g.open(e, o, !0),
        l.binary && (g.responseType = "arraybuffer"),
        m && (g.withCredentials = !0),
        ...
        try {
            ...
            return i.emit("noConnection", "http"),
            Promise.reject(e)
        }
        ...
        getFile: function(n, i) {
            ...
            return a && (i.aboluteURL || a.version === e.version) && (!i.test || a.data && a.data[i.test]) ? Promise.resolve(a.data) : new Promise(function(a, r) {
                t.get(i.aboluteURL ? n : e.assets + "/" + n).then(function(t) {
                    ...
                    !i.test || i.test in t.data ? (s.put(n, t),
                    a(t.data)) : r("File did not passed the test")
                }).catch(function(e) {
...
W.define("Color", ["utils", "store", "Class"], function(e, t, n) {
    return n.extend({
        ...
        createGradientArray: function(e, t, n) {
            ...
            void 0 === t && (t = !1),
            void 0 === n && (n = 1);
            var i, s, a, r, o = this.steps + 1, l = new Uint8Array(o << 2), c = (this.max - this.min) / this.steps, d = 0, u = this.gradient, h = 1, f = u[0], m = u[h++];
            for (r = 0; r < this.steps; r++)
                (i = (this.min + c * r) * n) > m[0] && h < u.length && (f = m,
                m = u[h++]),
                a = (i - f[0]) / (m[0] - f[0]),
                s = this.getGradientColorYUVA(f[1], m[1], a),
        ...
        getColor: function() {
            var e = this;
            return this.colors ? this : (this.gradient = t.get(this.key),
            this.setMinMax(),
    ...
    return s.extend({
        ...
        moveTs: function(t, n) {
            ...
            n) {
                ...
                if (s > -1)
                    return s = e.bound(s + (t ? 1 : -1), 0, this.acTimes.length),
                    i.set("acTime", this.acTimes[s]),
                    !0
            } else {
                var a = this.calendar
                  , r = a.paths
        ...
        open: function() {
            var e = this;
            return t.isMobileOrTablet || this.printLogo(),
            this.loadingPromise ? this.loadingPromise : Date.now() < this.productExpires ? Promise.resolve(this.calendar) : (this.loadingPromise = new Promise(function(t) {
                e.loadMinifest().then(function(t) {
                    ...
                    delete n.refTime),
                    e.minifest.ref !== n.ref && (e.minifest = n,
                    e.calendar = a.instance({
                        numOfHours: e.forecastSize,
                        minifestFile: e.minifest
                    }),
                    i.set("lastModified", new Date(e.minifest.ref).getTime()))
                }).catch(function(t) {
                    e.createBackupMinifest(),
                    window.wError("Product", "Minifest load/parsing failed", t)
                }).then(function() {
                    e.setExpireTime(),
...
W.define("Layer", ["Class", "products", "utils", "rootScope", "store"], function(e, t, n, i, s) {
    return e.extend({
        ...
        getParams: function(e, a) {
            ...
            if (c.hasMoreLevels ? l.includes(c.level) || (c.level = l[0]) : c.level = "surface",
...
W.define("trans", ["utils", "storage", "rootScope", "store", "seoParser", "langEn"], function(e, t, n, i, s, a) {
    ...
    return "loading" !== document.readyState ? m() : document.addEventListener("DOMContentLoaded", m),
    o
}),
/*! */
...
W.define("colors", ["Color"], function(e) {
    return {
        ...
        pm2p5: e.instance({
            ident: "pm2p5",
            steps: 1024,
            default: [[0, [0, 102, 151, 256]], [10, [125, 182, 209, 256]], [15, [170, 183, 189, 256]], [25, [194, 195, 125, 256]], [150, [232, 83, 25, 256]], [200, [189, 52, 19, 256]], [1e3, [75, 12, 0, 256]]]
        }),
        no2: e.instance({
            ident: "no2",
            steps: 4096,
            default: [[0, [0, 102, 151, 256]], [1.5, [125, 182, 209, 256]], [2, [170, 183, 189, 256]], [3, [194, 195, 125, 256]], [30, [232, 83, 25, 256]], [40, [189, 52, 19, 256]], [100, [75, 12, 0, 256]]]
        }),
        so2: e.instance({
            ident: "so2",
            steps: 1024,
...
W.define("Plugin", ["Class", "rootScope", "utils", "trans"], function(e, t, n, i) {
    return e.extend({
        ...
        load: function() {
            var e = this;
            return this.isLoaded ? Promise.resolve(!0) : this.loading ? this.promise : (this.loading = !0,
...
W.define("pluginsCtrl", ["rootScope", "plugins", "broadcast", "utils"], function(e, t, n, i) {
    ...
    function a(n, a) {
        ...
        o && (o.exclusive && ("all" === o.exclusive ? i.each(t, function(e, t) {
            e.isOpen && t !== n && r(t)
        }) : "rhpane" !== o.exclusive && "lhpane" !== o.exclusive || (t.detail.close(),
        t.rplanner.close(),
        t.station.close(),
        e.isMobile ? (s(n, "rhpane"),
        s(n, "lhpane")) : s(n, o.exclusive))),
        o.open(a))
    }
    function r(e, n) {
        var i = t[e];
...
W.define("timeAnimation", ["utils", "store", "products", "broadcast"], function(e, t, n, i) {
    var s, a, r = !1, o = null, l = null, c = 2, d = !1, u = 50;
    t.on("animation", function(e) {
        e !== r && (e ? function() {
            ...
            t.on("product", p),
            t.on("overlay", m),
            i.on("redrawFinished", f),
            i.on("paramsChanged", g),
            i.on("pluginOpened", p),
            v(),
        ...
        t.off("product", p),
        t.off("overlay", m),
        i.off("redrawFinished", f),
        i.off("paramsChanged", g),
        i.off("pluginOpened", p)))
    });
    var h = function(e) {
        e || p()
    }
...
W.define("Renderer", ["plugins", "Class"], function(e, t) {
    return t.extend({
        ...
        open: function(t) {
            ...
            this.isMounted = !0,
            Promise.resolve()) : this.loadingPromise ? this.loadingPromise : (this.loadingPromise = new Promise(function(i) {
        ...
        getTiles: function(n) {
            ...
            if (Math.floor(r) === r) {
                ...
                l.forEach(function(e) {
                    ...
                    if ((t = s.processTile(t, n)) && !y[t.url]) {
                        y[t.url] = 1;
                        var a = s.loader.loadTile(t);
                        b.push(a)
                    }
                }),
                Promise.all(b).then(this.postProcess.bind(this, this.syncCounter, w, n))
            }
        },
            ...
            var a = this
              , r = function(e, i) {
                ...
                var w = g[v]
                  ...
                  , N = m * m
                  , I = (w * P + y * R + E * O + A * D) / N
                  , W = s.interpolateNearestG ? t.interpolateNearest(null, 0, b, T, M, C, P, R, O, D) : (b * P + T * R + M * O + C * D) / N
                  , k = (L * P + S * R + x * O + _ * D) / N;
...
W.define("renderTile", ["render", "layers"], function(e, t) {
    return function(n, i, s, a, r) {
        if (s === this.syncCounter) {
            Date.now();
            n |= 0;
            var o, l = this.latestParams, c = l.isMultiColor, d = r.data, u = i.getContext("2d"), h = e.imgData.data;
            "png" === l.fileSuffix ? l.PNGtransparency && (o = e.testPNGtransparency) : l.JPGtransparency && (o = e.testJPGtransparency);
            var f, m, p, g, v, w, y, b, T, L, S, E, A = !1, M = 0 | a.trans, C = 0 | Math.log2(M), x = 0 | Math.log2(M * M), _ = 0 | a.intX, P = 0 | a.intY, R = 256 >> C, O = e.getWTable(M), D = 0, N = 0, I = _ * R | 0, k = P * R | 0, U = 0, F = 0, G = 256, H = 0, z = 0, B = 0, V = 0, j = 0, Y = 0, q = 0, Z = 0, X = 0, Q = 0, J = 0, $ = t[l.layer], K = "B" === l.renderFrom, ee = "RG" === l.renderFrom, te = r.decodeR, ne = r.decodeG;
            for (c ? (T = e.createCombinedFillFun(h, $.getColor(), $.getColor2(), $.getAmountByColor),
            L = e.createFillFun(h, n, $.getColor())) : T = L = e.createFillFun(h, n, $.getColor()),
            K && (te = r.decodeB),
            E = 0; E < 256; E += n)
                for (B = E - ((F = E >> C) << C),
                S = 0; S < 256; S += n)
                    ...
                    J = d[N + 1033]),
                    G = U),
                    A ? L(S, E, NaN) : (y = te(null !== O ? V * O[D = z + (B << C) << 2] + j * O[D + 1] + Y * O[D + 2] + q * O[D + 3] >> x : V * (f = (1 - (v = z / M)) * (1 - (w = B / M))) + j * (m = v * (1 - w)) + Y * (p = w * (1 - v)) + q * (g = v * w)),
                    !0 === ee && (b = ne(null !== O ? Z * O[D] + X * O[D + 1] + Q * O[D + 2] + J * O[D + 3] >> x : Z * f + X * m + Q * p + J * g)),
                    c ? T(S, E, y, b) : T(S, E, ee ? Math.sqrt(y * y + b * b) : y));
            u.putImageData(e.imgData, 0, 0),
            "pattern"in l && l.pattern in W && W[l.pattern].addPattern(u, M, d, 2056, I, k, R, te, ne)
        }
    }
}),
/*! */
...
W.define("ImageGraph", ["ImageMaker"], function(e) {
    return e.extend({
        ...
        render: function(e, t) {
            void 0 === t && (t = 1),
            this.checkData(e);
            var n, i, s = this.ctx, a = e.length, r = this.tdWidth, o = r >> 1, l = this.h, c = [], d = -r - o, u = this.viewport || this.findMinMax(e), h = u[0], f = u[1];
            for (i = 0; i < a + 4; ++i)
...
W.define("LabelsLayer", ["products", "http", "rootScope", "utils", "overlays", "store", "broadcast", "singleclick"], function(e, t, n, i, s, a, r, o) {
    return L.GridLayer.extend({
        ...
        onAdd: function() {
            ...
            this.createTilesUrl(),
            o.on("poi-label", this.onClick, this),
            a.on("timestamp", this.onTsChange, this),
            a.on("usedLang", this.updateLabels, this),
            a.on("englishLabels", this.updateLabels, this),
            a.on("product", this.updateProduct.bind(this, "refresh")),
            r.on("metricChanged", this.refreshWeather, this),
            this.hasHooks = !0),
            L.GridLayer.prototype.onAdd.call(this)
        },
        createTilesUrl: function() {
            var e = a.get("englishLabels") ? "en" : a.get("usedLang");
            this.tilesUrl = n.tileServer + "/labels/v1.3/" + e,
        ...
        onTsChange: function(e) {
            Math.abs(e - this.ts) > 1.5 * i.tsHour && (this.ts = e,
            this.refreshWeather())
        },
        toArray: function() {
            var e = [];
        ...
        renderTile: function(e, t, n) {
            for (var s = this._getTilePos(t), a = s.x, r = s.y, o = this._map.getPixelOrigin(), l = o.x, c = o.y, d = 256 << t.z, u = [], h = 0; h < n.length; ++h) {
                var f = n[h]
                  ...
                  , b = f[6]
                  , T = "ci" !== g.substr(0, 2)
                  , L = T ? m : w.toFixed(2) + "/" + v.toFixed(2)
                  , S = Math.floor(i.lonDegToXUnit(v) * d - l - y / 2) - a
                  , E = Math.floor(i.latDegToYUnit(w) * d - c - b / 2) - r
...
W.define("map", ["render", "plugins", "WindyMap", "rootScope", "utils", "store", "broadcast", "geolocation", "router"], function(e, t, n, i, s, a, r, o, l) {
    ...
    var c, d = 0, u = "location" === a.get("startUp") ? a.get("homeLocation") : l.sharedCoords || o.getMyLatestPos();
    ...
    function p() {
        ...
        c.baseLayer = L.tileLayer(e.graymap, {
            detectRetina: !1,
            minZoom: 3,
            maxZoom: 11,
            updateWhenIdle: !!i.isMobileOrTablet,
...
function() {
    ...
    h("Checking Leaflet library"),
    L || f("Leaflet is missing. Add Leaflet to the HTML head tag."),
    /^1\.4/.test(L.version) || f("Wrong version of Leaflet library. Version 1.4.x is required");
    !function() {
        var e = d("rootScope");
        if ("pro" === r) {
            var t = function(e, t) {
            ...
            e.overlays = t(e.overlays, i),
            e.localProducts = t(e.localProducts, i),
            e.globalProducts = t(e.globalProducts, i)
        } else
            n ? (e.localProducts = ["namConus", "namHawaii", "namAlaska", "iconEu", "arome"],
            e.globalProducts = ["gfs", "sea", "geos5", "gfsWaves", "iconGlobal", "satellite"],
            e.seaProducts = ["sea", "gfsWaves"],
            e.overlays = ["wind", "gust", "gustAccu", "rain", "rainAccu", "snowAccu", "snowcover", "ptype", "temp", "dewpoint", "rh", "deg0", "clouds", "hclouds", "mclouds", "lclouds", "fog", "cape", "waves", "swell1", "swell2", "wwaves", "currents", "cosc", "dustsm", "so2sm", "pressure", "satellite"],
            e.isolines = ["off", "pressure", "gh", "temp"]) : (e.localProducts = [],
            e.globalProducts = ["gfs", "sea", "gfsWaves"],
            e.overlays = ["wind", "rain", "temp", "clouds", "waves", "currents", "pressure"],
            e.isolines = ["off", "pressure", "gh", "temp"]);
        e.seaProducts = ["sea", "gfsWaves"],
        e.products = e.globalProducts.concat(e.localProducts)
    }(),
    d("trans");
    var m = function() {
        var e = d("libHtml")
        ...
        var o = t("#windy");
        o || f('Missing <div id="windy"></div> in the BODY of the page'),
        o.innerHTML = e.replace("__APIUSER__", i),
        o.classList.add(n ? "paid-model" : "free-model"),
        setTimeout(function() {
            a.translateDocument(o),
            h("Adding start-up options"),
            p(s, r),
            h("Initalizing rest of Windy API"),
            g()
        }, 50)
    }
      , p = function(e) {
        var i = d("rootScope")
          ...
          , a = !n;
        if (e.setDefault("favOverlays", s),
        e.setDefault("expertMode", t.expertMode || a),
        (t.lat || t.lon || t.lng) && (e.set("startUp", "location"),
        e.set("homeLocation", {
            lat: t.lat,
            lon: t.lon || t.lng,
            zoom: t.zoom || 5
        ...
        "basic" === r) {
            e.setDefault("product", "gfs"),
            e.setDefault("prefferedProduct", "gfs"),
            e.setDefault("availProducts", ["gfs"]),
            e.setDefault("visibleProducts", ["gfs"])
        }
        ["overlay", "level", "particles", "numDirections", "lang", "disableWebGL", "graticule", "particlesAnim", "timestamp", "isolines", "isImperial", "latlon", "hourFormat"].forEach(function(n) {
      ...
      , g = function() {
        ...
        h("Done. Calling your windyInit callback"),
        e.open = function(e) {
        ...
        ,
        t.overlay && n.set("overlay", t.overlay),
        g(r.version + "/" + i + "-" + s + "/" + a),
        o({
            map: m,
            store: n,
        ...
        u && v(),
        setTimeout(function() {
            console.log("%c 🏄 Welcome to Windy JavaScript API. Please do not remove or conceal the Windy logo or the advertisement. The logo and the advertisement must remain a clickable link, and must lead to its target URL. Please see https://api.windy.com/ for documentation and for more information.", "color: #9D0300; font-size: large")
        }, 200)
    }
      , v = function() {
        var e = d("$")
        ...
        n.load.call(n).catch(function() {
            ...
            n.innerHTML = '<a id="open-in-app" data-do="openapp" class="clickable" data-t="MENU_MOBILE"></a>',
            t.translateDocument(n);
